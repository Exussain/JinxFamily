...
class Product(models.Model):
    ...
    image_url = models.CharField(max_length=500, blank=True, help_text="آدرس کاور مربعی یا پیش‌فرض")
    cover_16_9 = models.CharField(max_length=500, blank=True, help_text="کاور 16:9 محصول (تصویر بزرگ در صفحه محصول)")
