...
class CORSMiddleware:
    ...
    environment variable as a comma‑separated list, for example:
        ...
        DJANGO_CORS_ALLOWED_ORIGINS="https://nubixshop.ir,http://87.248.150.150:4000,http://localhost:3000"
    """
    ...
    def __init__(self, get_response):
        ...
        default_origins = {
            # Production (nubixshop.ir)
            "https://nubixshop.ir",
            "http://nubixshop.ir",
            "https://www.nubixshop.ir",
            "http://www.nubixshop.ir",
