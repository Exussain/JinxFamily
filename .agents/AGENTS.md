...
- **Mandatory GitHub Push Target**: Every major change and codebase update MUST be committed and pushed to the official repository [**Exussain/JinxFamily**](https://github.com/Exussain/JinxFamily) (`https://github.com/Exussain/JinxFamily.git`). All legacy or external GitHub repo references (such as NubixShop) are strictly forbidden and removed.
