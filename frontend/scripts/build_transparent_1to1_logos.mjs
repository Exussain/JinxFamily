...
// Pure 1:1 Official Vector Logos on 100% transparent background with subtle brand glow
const TRANSPARENT_LOGOS = {
  category_valorant: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_val" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#FF4655" flood-opacity="0.8"/>
        </filter>
      </defs>
  ...
  category_marvel_rivals: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" width="400" height="400">
      <defs>
        <filter id="glow_mr" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#E11D48" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_pubg" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#F97316" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_cod" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#EAB308" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_bs" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#FACC15" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_ff" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#EF4444" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_fn" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#A855F7" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_rl" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#3B82F6" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_ping" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#38BDF8" flood-opacity="0.8"/>
        </filter>
      </defs>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="380" height="380">
      <defs>
        <filter id="glow_mg" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="6" stdDeviation="8" flood-color="#EC4899" flood-opacity="0.8"/>
        </filter>
      </defs>
...
async function buildTransparentLogos() {
  console.log('Launching Playwright for 100% transparent vector logo rendering...');
  const browser = await chromium.launch({ headless: true });
  const page = await browser.newPage({ viewport: { width: 500, height: 500 }, deviceScaleFactor: 2 });

  for (const [key, svgContent] of Object.entries(TRANSPARENT_LOGOS)) {
    ...
    console.log(`Rendered transparent vector logo for ${key} -> ${pngPath}`);
  }

  await browser.close();
  console.log('Playwright transparent logo rendering completed successfully!');
}

buildTransparentLogos().catch(console.error);
