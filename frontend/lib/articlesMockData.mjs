...
export const IMPORTED = [
  { id: 1, slug: 'why-choose-nubix', title: 'چرا نوبیکس شاپ را انتخاب کنیم؟ خرید قانونی با پشتیبانی ۲۴ ساعته', excerpt: 'دلایل انتخاب نوبیکس شاپ برای خرید امن و قانونی محصولات دیجیتال و گیمینگ.', date: '۱۰ تیر ۱۴۰۵', cover_image: '/media/blog/covers/why_choose_nubix_banner.jpg', label: 'WHY NUBIX' },
  { id: 2, slug: 'how-orders-completed', title: 'سفارشات چگونه تکمیل می‌شوند؟ فرآیند کاملاً خودکار و هوشمند', excerpt: 'نگاهی به فرآیند خودکار پردازش و تحویل سفارش‌ها در نوبیکس شاپ.', date: '۱۰ تیر ۱۴۰۵', cover_image: '/media/blog/covers/automated_orders_banner.jpg', label: 'AUTO ORDERS' },
  { id: 3, slug: 'track-my-order', title: 'چگونه سفارش خود را پیگیری کنم؟ سیستم رهگیری لحظه‌ای و پیامک', excerpt: 'راهنمای پیگیری لحظه‌ای وضعیت سفارش و دریافت اطلاع‌رسانی پیامکی.', date: '۱۰ تیر ۱۴۰۵', cover_image: '/media/blog/covers/track_order_banner.jpg', label: 'TRACK ORDER' },
  { id: 4, slug: 'support-hours', title: 'ساعات کاری پشتیبانی چیست؟ پاسخگویی تلفنی و آنلاین', excerpt: 'ساعات پاسخگویی تیم پشتیبانی نوبیکس شاپ از طریق تلفن و چت آنلاین.', date: '۰۹ تیر ۱۴۰۵', cover_image: '/media/blog/covers/support_hours_banner.jpg', label: 'SUPPORT 24/7' },
  { id: 5, slug: 'payment-methods', title: 'روش پرداخت چگونه است؟ درگاه پرداخت رسمی زرین‌پال و شاپرک', excerpt: 'روش‌های پرداخت امن نوبیکس از طریق درگاه رسمی زرین‌پال و شبکه شاپرک.', date: '۰۹ تیر ۱۴۰۵', cover_image: '/media/blog/covers/payment_methods_banner.jpg', label: 'SECURE PAY' },
  { id: 6, slug: 'can-i-trust-nubix', title: 'آیا می‌توانم به نوبیکس اعتماد کنم؟ نماد اعتماد الکترونیکی و دفتر رسمی', excerpt: 'مجوزها، نماد اعتماد الکترونیکی و دفتر رسمی نوبیکس شاپ را بشناسید.', date: '۰۸ تیر ۱۴۰۵', cover_image: '/media/blog/covers/trust_nubix_banner.jpg', label: 'TRUST & SAFETY' },
  { id: 7, slug: 'available-products', title: 'چه محصولاتی در نوبیکس موجود است؟ بازی‌ها، ویباکس و اشتراک‌ها', excerpt: 'فهرست کامل محصولات نوبیکس شاپ؛ از وی‌باکس و گیفت کارت تا اشتراک‌های هوش مصنوعی.', date: '۰۸ تیر ۱۴۰۵', cover_image: '/media/blog/covers/available_products_banner.jpg', label: 'CATALOG' },
  { id: 8, slug: 'why-some-virtual-cards-fail', title: 'چرا برخی کارت‌های مجازی کار نمی‌کنند؟ بررسی محدودیت‌های ترکیه', excerpt: 'دلایل رد شدن برخی کارت‌های مجازی و نکات مهم درباره محدودیت‌های منطقه‌ای.', date: '۰۷ تیر ۱۴۰۵', cover_image: '/media/blog/covers/virtual_cards_banner.jpg', label: 'VIRTUAL CARDS' },
