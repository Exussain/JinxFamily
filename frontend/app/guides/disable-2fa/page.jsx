        ...
        <div className="guide-article-box">
          ...
          <div className="guide-article-info-bar">
            <div className="guide-info-item">
              <span>✍️</span>
              <span>تنظیم‌کننده: بخش آموزش جینکس فمیلی</span>
            </div>
            <div className="guide-info-item">
              <span>📅</span>
          ...
          <div className="guide-article-content">
            <p className="guide-intro">
              برای تکمیل سریع سفارش و فعال‌سازی آیتم‌ها روی حساب شما، کارشناسان جینکس فمیلی باید وارد اکانت بازی شوند. فعال بودن تایید دو مرحله‌ای (2FA) روند ورود تیم ما را متوقف کرده و ممکن است تحویل سفارش شما را تا ۴۸ ساعت به تعویق بیندازد. از این رو پیش از خرید، غیرفعال کردن 2FA را به شما توصیه می‌کنیم. مطمئن باشید تیم پشتیبانی جینکس فمیلی تا لحظه تکمیل کامل سفارش در کنار شماست.
            </p>
              ...
              {(
                <div className="guide-section" hidden={activeTab !== "playstation"}>
                  ...
                  <div className="tip-box">
                    ...
                    <p>پشتیبانی جینکس فمیلی توصیه می‌کند پس از تکمیل و تحویل کامل سفارش، تایید دو مرحله‌ای حساب خود را دوباره فعال کنید.</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="guide-footer">
              ...
              <p>اگر با خطا مواجه شدید یا مراحل بالا نتیجه نداد، کارشناسان پشتیبانی جینکس فمیلی در تلگرام تا تکمیل کامل سفارش همراه شما هستند.</p>
              <a href="https://t.me/JinxFamilySupport" target="_blank" rel="noopener noreferrer" className="support-btn">
...
ارتباط با پشتیبانی جینکس فمیلی در تلگرام
              </a>
            </div>
          </div>
        </div>
