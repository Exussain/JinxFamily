          ...
          <div className="guide-article-content">
            ...
            <div className="info-banner">
              ...
              <div>
                ...
                <p>خرید محصولات فورتنایت در جینکس فمیلی روی ریجن‌ها و پلتفرم‌های مقرون‌به‌صرفه‌تر انجام می‌شود. با لینک بودن اکانت اپیک گیمز به حساب پی‌اس‌ان یا ایکس‌باکس شما، محصولات خریداری‌شده به‌صورت خودکار روی کنسول شخصی‌تان نیز فعال و قابل استفاده خواهند بود.</p>
              </div>
            </div>
            ...
            <div className="guide-footer">
              ...
              <p>اگر با پیام‌هایی مانند «This account is already linked to another Epic Games account» روبه‌رو شدید، کارشناسان پشتیبانی جینکس فمیلی تا رفع کامل مشکل و تکمیل سفارش در کنار شما هستند.</p>
