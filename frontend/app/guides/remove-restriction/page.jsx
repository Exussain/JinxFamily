        ...
        <div className="guide-article-box">
          ...
          <div className="guide-article-content">
              ...
              <div className="platform-section">
                ...
                <div className="restriction-type">
                  ...
                  <div className="steps-compact">
                    <div className="step-compact">
                      <span className="step-num">۱</span>
                      <span>کد ارسال‌شده به ایمیل یا موبایل خود را در اسرع وقت برای پشتیبانی جینکس فمیلی بفرستید.</span>
                    </div>
                    <div className="step-compact">
                      <span className="step-num">۲</span>
            ...
            <div className="guide-footer">
              ...
              <p>اگر با خطای دیگری مواجه شدید یا نتوانستید قفل حساب خود را باز کنید، کارشناسان جینکس فمیلی تا رفع کامل مشکل و تکمیل سفارش در کنار شما هستند.</p>
