      ...
      <main className="container home-shell home-index">
        ...
        <section className="home-seo-section" aria-labelledby="home-seo-title">
          ...
          <p>
            ...
            فروشگاه نوبیکس (که در میان کاربران با نام‌های نوبیکس شاپ، نوبيکس، نوبيكس، نوبیكس، نوبیكس شاپ یا NubixShop نیز شناخته می‌شود) متعهد به ارائه بهترین خدمات دیجیتال با قیمت مناسب است.
